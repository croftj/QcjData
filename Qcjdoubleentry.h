...
# ifndef QCJDOUBLEENTRY_H
#define  QCJDOUBLEENTRY_H

# include <QString>
# include "ui_Qcjdoubleentry.h"

class QcjDoubleEntry : public QWidget
{
   Q_OBJECT

public:
   QcjDoubleEntry(QWidget *p = 0);
   void setText( QString s );
   QString text();
   void setLabel( QString s );
   void setMin( double dv );
   void setMax( double dv);

private:
   Ui::QcjDoubleEntry ui;
};
# endif
