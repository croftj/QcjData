...
class QDesignerFrameEditorInterface;


class QcjDataFramePlugin : public QObject, public QDesignerCustomWidgetInterface 
{
    Q_OBJECT
    Q_INTERFACES(QDesignerCustomWidgetInterface)
public:
    QcjDataFramePlugin(QObject *parent = 0);
    ...
    void initialize(QDesignerFrameEditorInterface *core);
