...
# ifndef QCJSINGLELINEENTRY_H
#define  QCJSINGLELINEENTRY_H

# include <QString>
# include "ui_Qcjsinglelineentry.h"

class QcjSingleLineEntry : public QWidget
{
   Q_OBJECT

public:
   QcjSingleLineEntry(QWidget *p);
