...
QcjYesNoEntry::QcjYesNoEntry(QWidget *p) : QWidget(p)
{
    ui.setupUi(this);
}

void QcjYesNoEntry::setText( QString s )
{
   QString s1;
   if ( s.toInt() != 0 || 
...
QString QcjYesNoEntry::text()
{
   return(ui.QcjYesNoSelect->currentText());
}

QString QcjYesNoEntry::shortenedText()
{
...
void QcjYesNoEntry::setLabel( QString )
{
}
